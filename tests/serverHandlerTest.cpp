...
// 		CHECK_EQUAL(std::string(result), std::string(":localhost.3000 SERVER localhost.3001 2 3 :kikik kiki"));
// 		free(result);
...
// TODO 215, 221 리턴값 222 맵에 등록됨 리턴 문자열
