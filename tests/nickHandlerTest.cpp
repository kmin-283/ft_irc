...
TEST(UserSendNickMessageTest, PrefixError)
{
	...
	given(server, CONNECT, std::string("ERROR :Invalid prefix \"\"\r"), std::string("dakim"));
	expect(Message(std::string(":d"), std::string("NICK"), std::string("")));
	given(server, CONNECT, std::string("ERROR :Invalid prefix \"d\"\r"), std::string("dakim"));
	expect(Message(std::string(":sdfss"), std::string("NICK"), std::string("")));
	given(server, CONNECT, std::string("ERROR :Invalid prefix \"sdfss\"\r"), std::string("dakim"));
...
TEST(ServerSendNickMessageTest, PrefixError)
{
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(": NICK\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"\"\r"));
		free(result);
		expect(Message(std::string(":sdfss NICK\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"sdfss\"\r"));
		free(result);
		expect(Message(std::string(":sdfss NICK dakim :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"sdfss\"\r"));
		free(result);
		expect(Message(std::string(":dakim NICK dakim :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"dakim\"\r"));
		free(result);
		expect(Message(std::string(":lo1 NICK dakim :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		...
		expect(Message(std::string(":lo3 NICK\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"lo3\"\r"));
		free(result);
		expect(Message(std::string(":lo3 NICK lo1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"lo3\"\r"));
		free(result);
...
TEST(ServerSendNickMessageTest, ParameterError)
{
	...
	if (pipe(fd) != -1)
	{
		...
		free(result);
		expect(Message(std::string("NICK dakim\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string("NICK dakim 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string("NICK dakim 1 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string("NICK dakim 1 1 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string("NICK dakim 1 1 1 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string("NICK dakim 1 1 1 1 1 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
...
TEST(ServerSendNickMessageTest, NotVaildNick)
{
	int		fd[2];
	char	*result;
	Server	server("111", "3000");
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string("NICK !de :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 432 !de lo2 :Erroneous nickname\r"));
		free(result);
		expect(Message(std::string("NICK sdfsdffssfde :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 432 sdfsdffssfde lo2 :Erroneous nickname\r"));
		free(result);
		expect(Message(std::string(":lo2 NICK !de 1 ~deok localhost 1 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 432 !de lo2 :Erroneous nickname\r"));
		free(result);
		expect(Message(std::string(":lo2 NICK sdfsdffssfde 1 ~deok localhost 1 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 432 sdfsdffssfde lo2 :Erroneous nickname\r"));
		free(result);
...
TEST(ServerSendNickMessageTest, LocalUserNickOverlapTwoParameters)
{
	int		fd[6];
	char	*result;
	Client	*client;
	...
	{
		otherServer = new Client(fd[5], true);
		otherServer->setStatus(SERVER);
		otherServer->setInfo(UPLINKSERVER, std::string("lo1"));
		otherServer->setInfo(SERVERNAME, std::string("lo3"));
		otherServer->setInfo(HOPCOUNT, std::string("1"));
		otherServer->setInfo(SERVERINFO, std::string("sexy server"));
		server.acceptClients[fd[5]] = *otherServer;
		server.sendClients[std::string("lo3")] = *otherServer;
		server.serverList[std::string("lo3")] = &server.sendClients[std::string("lo3")];
		...
		expect(Message(std::string("NICK dakim :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
...
TEST(ServerSendNickMessageTest, LocalUserNickOverlapSevenParameters)
{
	int		fd[6];
	char	*result;
	Client	*client;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		server.sendClients[std::string("dakim")] = *client;
		server.clientList[std::string("dakim")] = &server.sendClients[std::string("dakim")];
		expect(Message(std::string(":lo2 NICK dakim 1 ~deok localhost 1 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		CHECK_EQUAL(server.acceptClients.count(fd[3]), 0);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 KILL dakim :Nick collision\r"));
...
TEST(ServerSendNickMessageTest, RemoteUserNickOverlapTwoParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		client = new Client(fd[3], true);
		client->setStatus(USER);
		client->setInfo(UPLINKSERVER, std::string("lo3"));
		client->setInfo(NICK, std::string("dakim"));
		client->setInfo(ADDRESS, std::string("127.0.0.1"));
		client->setInfo(USERNAME, std::string("dak"));
		client->setInfo(REALNAME, std::string("deok"));
...
TEST(ServerSendNickMessageTest, RemoteUserNickOverlapSevenParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
...
TEST(ServerSendNickMessageTest, RemoteUserNickAndServerNameOverlapTwoParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		client->setInfo(REALNAME, std::string("deok"));
		server.sendClients[std::string("dakim")] = *client;
		expect(Message(std::string("NICK lo1 :1\r\n")), fd[1]);
...
TEST(ServerSendNickMessageTest, RemoteUserNickAndServerNameOverlapSevenParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		client->setInfo(REALNAME, std::string("deok"));
		server.sendClients[std::string("dakim")] = *client;
		expect(Message(std::string(":lo2 NICK lo1 1 ~deok localhost 1 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 1);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 KILL lo1 :Nick collision\r"));
		free(result);
...
TEST(ServerSendNickMessageTest, RemoteUserNickAndOtherServerNameOverlapTwoParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		client->setInfo(REALNAME, std::string("deok"));
		server.sendClients[std::string("dakim")] = *client;
		expect(Message(std::string("NICK lo4 :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 1);
		get_next_line(fd[0], &result);
...
TEST(ServerSendNickMessageTest, RemoteUserNickAndOtherServerNameOverlapSevenParameters)
{
	int		fd[6];
	char	*result;
	Client	*otherServer;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		client->setInfo(REALNAME, std::string("deok"));
		server.sendClients[std::string("dakim")] = *client;
		expect(Message(std::string(":lo2 NICK lo4 1 ~deok localhost 1 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 1);
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 KILL lo4 :Nick collision\r"));
		free(result);
...
TEST(ServerSendNickMessageTest, ServerTokenError)
{
	int		fd[2];
	Server	server("111", "3000");
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":lo2 NICK dakim 1 ~deok localhost 2 +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		expect(Message(std::string(":lo2 NICK dakim 1 ~deok localhost sdfsdf +o :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		close(fd[0]);
		close(fd[1]);
	}
...
TEST(ServerSendNickMessageTest, ModePrefixError)
{
	int		fd[2];
	Server	server("111", "3000");
...
TEST(ServerSendNickMessageTest, InvalidUserMode)
{
	int		fd[2];
	Server	server("111", "3000");
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":lo2 NICK dakim 1 ~deok localhost 1 +! :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 0);
		close(fd[0]);
		close(fd[1]);
	}
...
TEST(ServerSendNickMessageTest, RegisterUserSevenParameters)
{
	int		fd[2];
	Client	*client;
	Server	server("111", "3000");
	...
	if (pipe(fd) != -1)
	{
		...
		CHECK_EQUAL(client->getInfo(USERMODE), std::string("o"));
...
TEST(ServerSendNickMessageTest, RegisterUserSevenParametersModeOverlap)
{
	int		fd[2];
	Client	*client;
	Server	server("111", "3000");
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":lo2 NICK dakim 1 ~deok localhost 1 +oo :1\r\n")), fd[1]);
		given(server, CONNECT, std::string("dakim"), 1);
		client = &server.sendClients[std::string("dakim")];
		CHECK_EQUAL(client->getStatus(), USER);
		CHECK_EQUAL(client->getInfo(USERNAME), std::string("deok"));
...
TEST(ServerSendNickMessageTest, RegisterUserBroadCast)
{
	int		i;
	int		fd[6];
	char	*result;
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		CHECK_EQUAL(registerClient->getInfo(USERMODE), std::string("o"));
		CHECK_EQUAL(server.sendClients.count(std::string("~deok")), 0);
		CHECK_EQUAL(server.sendClients.count(std::string("deok")), 0);
		CHECK_EQUAL(server.clientList.count(std::string("dakim")), 0);
...
TEST(ServerResendNickMessageNotUserTest, PrefixError)
{
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(": NICK :deok\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"\"\r"));
		free(result);
		expect(Message(std::string(":sdsdfsdf NICK :deok\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"sdsdfsdf\"\r"));
		free(result);
		expect(Message(std::string(":lo1 NICK :deok\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string("ERROR :Invalid prefix \"lo1\"\r"));
...
TEST(ServerResendNickMessageNotUserTest, PrefixIsServer)
{
	...
	if (pipe(fd) != -1)
	{
		...
		expect(Message(std::string(":lo4 NICK :deok\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
...
TEST(ServerResendNickMessageNotUserTest, ParameterSizeError)
{
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":dakim NICK\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string(":dakim NICK 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
		free(result);
		expect(Message(std::string(":dakim NICK 1 1 1\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
...
TEST(ServerResendNickMessageNotUserTest, ParameterFormError)
{
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":dakim NICK deok\r\n")), fd[1]);
		given(server, CONNECT, std::string("deok"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 461 lo2 NICK :Syntax error\r"));
...
TEST(ServerResendNickMessageNotUserTest, NotVaildNick)
{
	...
	if (pipe(fd) != -1)
	{
		expect(Message(std::string(":dakim NICK :!de\r\n")), fd[1]);
		given(server, CONNECT, std::string("!de"), 0, 1);
		CHECK_EQUAL(server.sendClients[std::string("dakim")].getInfo(NICK), std::string("dakim"));
		get_next_line(fd[0], &result);
		CHECK_EQUAL(std::string(result), std::string(":lo1 432 !de lo2 :Erroneous nickname\r"));
		free(result);
		expect(Message(std::string(":dakim NICK :sdfsdffssfde\r\n")), fd[1]);
...
TEST(ServerResendNickMessageNotUserTest, ReRegisterNick)
{
	...
	if (pipe(fd) != -1 && pipe(fd + 2) != -1 && pipe(fd + 4) != -1)
	{
		...
		server.nickHandler(Message(std::string(":dakim NICK :deok\r\n")), localServer);
		CHECK_EQUAL(server.sendClients.count(std::string("dakim")), 0);
		CHECK_EQUAL(server.sendClients.count(std::string("deok")), 1);
